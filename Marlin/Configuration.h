...
// 110 is Pt100 with 1k pullup (non standard)
  ...
  //#define MG_LCD_I2C //Дисплей на i2c шине
 ...
 //#define FIRMWARE_VERSION "Magnum-" MACHINE_MODEL "-B03-T5m" // Суперпауза, монитор прутка, добавлен Magnum 2000
 //#define FIRMWARE_VERSION "Magnum-" MACHINE_MODEL "-B03-T5p" // Не выкл. нагрев стола при супер паузе. монитор прутка выведен на пин13 (вывод 3 внешнего разъема)
 //#define FIRMWARE_VERSION "Magnum-" MACHINE_MODEL "-B03-T5pt" // DEFAULT_STEPPER_DEACTIVE_TIME увеличил с 60*3 до 5 минут
 //#define FIRMWARE_VERSION "Magnum-" MACHINE_MODEL "-B03-T5R" // Добавлен Лазер, косметические изменения меню
 //#define FIRMWARE_VERSION "Magnum-" MACHINE_MODEL "-B03-T5S" // Стол PID управление
 //#define FIRMWARE_VERSION "Magnum-" MACHINE_MODEL "-B03-T5U" // Надпись Паста на экране, включение пасты команды F и D, зажигание лазера, команда W раскомментировано
 //#define FIRMWARE_VERSION "Magnum-" MACHINE_MODEL "-B03-T5Ub" //Исправлено эхо, лазер работает из Репитера
 ...
 // Монитор прутка с периодическими импульсами при подаче
...
#ifdef PIDTEMPBED
// MG последняя версия стола
    #define  DEFAULT_bedKp 124.42
    #define  DEFAULT_bedKi 24.50
    #define  DEFAULT_bedKd 157.98
// Стол клепаный зеленый / не проверено толком
//    #define  DEFAULT_bedKp 90.45
//    #define  DEFAULT_bedKi 6.13
//    #define  DEFAULT_bedKd 333.44
...
//#define THERMAL_RUNAWAY_PROTECTION_BED_HYSTERESIS 2 // in degree Celsius
#if MOTHERBOARD == 555
  #define THERMAL_RUNAWAY_PROTECTION_PERIOD 60 //есть проблема если экструдер был нагрет, не сбрасывается этот период (исправлено) //in seconds
 ...
 // Все, получаем THERMAL RUNAWAY, если ставить ниже то ок. (Исправлено)
...
#if defined(MODUS) || defined(M2000)
 #define X_HOME_DIR -1
 #define Y_HOME_DIR -1
 #define Z_HOME_DIR -1
#else
...
// Travel limits after homing
 ...
 #define Z_MIN_POS_DEFAULT 0
	...
	#endif
#elif defined(M2000) 
 #define X_MAX_POS_DEFAULT 2100
 #define X_MIN_POS_DEFAULT 0
 #define Y_MAX_POS_DEFAULT 1045
 #define Y_MIN_POS_DEFAULT 0
 #define Z_MAX_POS_DEFAULT 1500
 #define Z_MIN_POS_DEFAULT 0 
#else
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    // is used to esimate the plane of the print bed
      ...
      #define ABL_PROBE_PT_3_X 15 //85
      #define ABL_PROBE_PT_3_Y 20
	#else
      #define ABL_PROBE_PT_1_X 85 //120
      #define ABL_PROBE_PT_1_Y 170
      #define ABL_PROBE_PT_2_X 220 //255
      #define ABL_PROBE_PT_2_Y 20
      #define ABL_PROBE_PT_3_X 15 //50
      #define ABL_PROBE_PT_3_Y 20
	#endif
...
#define DEFAULT_MAX_ACCELERATION      {3000,3000,100,3000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
 ...
 #define DEFAULT_ACCELERATION          1000    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
	...
	#define EXTRUDER_OFFSET_X {0.0, -9.00}
	#define EXTRUDER_OFFSET_Y {0.0, 0.00}
	#define EXTRUDER_OFFSET_Z {0.0, 0.00}
 #else
	#define DEFAULT_XYJERK                5.0    // (mm/sec)
	#define EXTRUDER_OFFSET_X {0.0, -35.00}
	#define EXTRUDER_OFFSET_Y {0.0, 0.00}
	#define EXTRUDER_OFFSET_Z {0.0, 0.00}
 #endif
#elif defined(M2000)
 #define DEFAULT_MAX_FEEDRATE          {200, 200, 9, 25}    // (mm/sec)
 #define DEFAULT_ACCELERATION          1000    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
 #define DEFAULT_XYJERK                5.0    // (mm/sec)
#else //UNI
 #define DEFAULT_MAX_FEEDRATE          {150, 150, 15, 35}    // (mm/sec)
 #define DEFAULT_ACCELERATION          1000    // X, Y, Z and E max acceleration in mm/s^2 for printing moves

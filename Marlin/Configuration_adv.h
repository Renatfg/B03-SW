...
#define DEFAULT_STEPPER_DEACTIVE_TIME 60*5//60*3
...
//adds support for experimental filament exchange support M600; requires display
  ...
  #define FILAMENTCHANGEENABLE
   ...
   #if MOTHERBOARD == 555 // MG
	#if defined(M2000)
		#define FILAMENTCHANGE_XPOS 800
		#define FILAMENTCHANGE_YPOS 1000
		...
		#define FILAMENTCHANGE_FINISHRETRACT 1
